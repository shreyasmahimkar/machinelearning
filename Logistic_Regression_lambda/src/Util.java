public class Util{
	 ...
	 * @param values -> list of actual - predicted values
	 * @return
	 */
	public static double SSE(double [] values){
		double sum =0;
	 ...
	 * @param values -> list of SSE
	 * @return
	 */
	public static double RMSE(double sse,int len){
